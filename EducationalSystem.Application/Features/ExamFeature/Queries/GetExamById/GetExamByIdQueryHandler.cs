...
{
    public class GetExamByIdQueryHandler : IRequestHandler<GetExamByIdQuery, GetByIdResponseDto<ExamDto>>
    {
        ...
        public async Task<GetByIdResponseDto<ExamDto>> Handle(GetExamByIdQuery request, CancellationToken cancellationToken)
        {
